document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
        ...
        const url = `https://b24-11t2ms.bitrix24.ru/rest/1/43ln4oz97uozw0uu/crm.lead.add.json?fields[NAME]=${encodeURIComponent(name)}&fields[EMAIL][0][VALUE]=${encodeURIComponent(email)}&fields[SERVICE]=${encodeURIComponent(service)}&fields[PHONE][0][VALUE]=${encodeURIComponent(phone)}&fields[COMMENTS]=${encodeURIComponent(comments)}`;
